...
export const api = {
  ...
  market: {
    ...
    dayTradingScanner: {
      method: 'GET' as const,
      path: '/api/market/daytrading-scanner',
      responses: {
        200: z.array(z.object({
          symbol: z.string(),
          name: z.string(),
          currentPrice: z.number(),
          patternType: z.enum(['cupid', 'powerRanger', 'rollerCoaster', 'tugOfWar']),
    ...
    monthTradingScanner: {
      method: 'GET' as const,
      path: '/api/market/month-trading-scanner',
      responses: {
        200: z.array(z.object({
          symbol: z.string(),
          name: z.string(),
          currentPrice: z.number(),
          patternType: z.enum(['breakout', 'accumulation', 'momentum', 'value']),
          patternName: z.string(),
          confidence: z.number(),
          entryPrice: z.number(),
          stopLoss: z.number(),
    ...
    rollerCoasterScanner: {
      method: 'GET' as const,
      path: '/api/market/rollercoaster-scanner',
      responses: {
        200: z.object({
          results: z.array(z.object({
            ...
            patternDetected: z.boolean(),
            confidence: z.number(),
            marketStage: z.enum(['Accumulation', 'Uptrend', 'Distribution', 'Downtrend']),
            entryLevel: z.number(),
            stopLoss: z.number(),
            targetPrice: z.number(),
            riskRewardRatio: z.number(),
            waterfallDepth: z.number(),
            retracementLevel: z.number(),
            wideRangeBarCount: z.number(),
            entryBarType: z.string(),
            isGoodLocation: z.boolean(),
    ...
    tugOfWarScanner: {
      method: 'GET' as const,
      path: '/api/market/tugofwar-scanner',
      responses: {
        200: z.object({
          results: z.array(z.object({
            symbol: z.string(),
            ...
            targetPrice: z.number(),
            riskRewardRatio: z.number(),
            consolidationTightness: z.number(),
            hasShakeoutBar: z.boolean(),
            nearMovingAverage: z.boolean(),
            maDistance: z.number(),
            isUptrend: z.boolean(),
            isGoodLocation: z.boolean(),
            setupNotes: z.array(z.string()),
    ...
    settings: {
      get: {
        ...
        responses: {
          200: z.object({
            ...
            host: z.string(),
            port: z.number(),
            tradeAccount: z.string().nullable().optional(),
      ...
      update: {
        ...
        input: z.object({
          host: z.string().min(1).max(100).optional(),
          port: z.number().int().min(1).max(65535).optional(),
          tradeAccount: z.string().max(50).optional().nullable(),
        }),
        responses: {
          200: z.object({
            id: z.number(),
            ...
            host: z.string(),
            port: z.number(),
            tradeAccount: z.string().nullable(),
            isConnected: z.boolean(),
          }),
          400: errorSchemas.validation,
        },
  ...
  moomooOrders: {
    list: {
      ...
      responses: {
        200: z.array(z.object({
          ...
          status: z.string(),
          moomooOrderId: z.string().nullable(),
    ...
    update: {
      ...
      responses: {
        200: z.object({ id: z.number(), status: z.string() }),
        404: errorSchemas.notFound,
        400: errorSchemas.validation,
      },
    },
  ...
  growthTargets: {
    list: {
      ...
      responses: {
        200: z.array(z.object({
          ...
          supportLevel1: z.string().nullable(),
          supportLevel2: z.string().nullable(),
          supportLevel3: z.string().nullable(),
          supportLevel4: z.string().nullable(),
          supportLevel5: z.string().nullable(),
          conservativeIV: z.string().nullable(),
          baseIV: z.string().nullable(),
          averageIV: z.string().nullable(),
          discountPremium: z.string().nullable(),
    ...
    bulkImport: {
      method: 'POST' as const,
      path: '/api/growth-targets/bulk',
      input: z.array(z.object({
        category: z.string().optional().nullable(),
        symbol: z.string(),
        companyName: z.string().optional().nullable(),
        currency: z.string().optional().nullable(),
        supportLevel1: z.string().optional().nullable(),
        supportLevel2: z.string().optional().nullable(),
        supportLevel3: z.string().optional().nullable(),
        supportLevel4: z.string().optional().nullable(),
        supportLevel5: z.string().optional().nullable(),
        conservativeIV: z.string().optional().nullable(),
        baseIV: z.string().optional().nullable(),
        averageIV: z.string().optional().nullable(),
        discountPremium: z.string().optional().nullable(),
        growthRate: z.string().optional().nullable(),
        moat: z.string().optional().nullable(),
        investmentType: z.string().optional().nullable(),
        notes: z.string().optional().nullable(),
      })),
      responses: {
        201: z.object({ imported: z.number() }),
        400: errorSchemas.validation,
      },
    },
    delete: {
      method: 'DELETE' as const,
      path: '/api/growth-targets/:id',
      responses: {
        204: z.void(),
        404: errorSchemas.notFound,
      },
